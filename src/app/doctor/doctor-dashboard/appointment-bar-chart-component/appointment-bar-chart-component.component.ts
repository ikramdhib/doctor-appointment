...
@Component({
  selector: 'app-appointment-bar-chart-component',
  standalone: true,
  imports: [CommonModule,NgApexchartsModule],
  templateUrl: './appointment-bar-chart-component.component.html',
  styleUrl: './appointment-bar-chart-component.component.scss'
})


export class AppointmentBarChartComponentComponent {
  doctorID:any;
  appointments:any;
  chartOptions: any;
